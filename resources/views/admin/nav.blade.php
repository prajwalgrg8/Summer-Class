<div class="sidebar">
  ...
  <a href="{{ route('admin.genre.index') }}" class="@if(request()->is('genres')) active @endif">Genres</a>
  <a href="{{ route('admin.user.index') }}" class="@if(request()->is('users')) active @endif">Users</a>
